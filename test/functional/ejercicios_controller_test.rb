...
class EjerciciosControllerTest < ActionController::TestCase
  ...
  test "should create ejercicio" do
    assert_difference('Ejercicio.count') do
      post :create, ejercicio: { nombre: @ejercicio.nombre, puntos: @ejercicio.puntos, rutina_id: @ejercicio.rutina_id }
    end
  ...
  test "should update ejercicio" do
    put :update, id: @ejercicio, ejercicio: { nombre: @ejercicio.nombre, puntos: @ejercicio.puntos, rutina_id: @ejercicio.rutina_id }
    assert_redirected_to ejercicio_path(assigns(:ejercicio))
  end
